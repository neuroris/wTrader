...
class KiwoomBase(QAxWidget, WookLog, WookUtil):
    def __init__(self, trader, log, key):
        ...
        # self.consecutive_interval_limit = 0.4
        self.request_time = 0
        self.request_interval_limit = 0.5
        self.request_block_time_limit = 5
        # self.request_block_time_limit = 2
        self.request_block_size = 10
        # self.request_block_size = 5
        ...
        self.screen_kospi200 = '0200'
        self.screen_kospi200_real = '0201'
    ...
    def report_fail_order(self):
        order = self.order_report
        self.info('\033[95mSend order failed.', 'Please check order variables\033[0m')
        self.info('\033[95m{}({}) {}, price:{}, amount:{}'.format(order.order_position, order.order_number,
                                                                  order.order_type, order.order_price,
                                                                  order.order_amount), '\033[0m')
