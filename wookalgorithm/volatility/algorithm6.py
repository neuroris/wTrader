...
5. The higher the price, the higher the loss limit 
'''

class VAlgorithm6(AlgorithmBase):
    ...
    def update_transaction_info(self, item):
        ...
        #     self.post('(BLOCK)', 'purchase ordered')
        #     return
        # elif self.sale_ordered:
        #     self.post('(BLOCK)', 'sale ordered')
        #     return
