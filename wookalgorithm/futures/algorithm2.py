...
3. Transaction timing catch and trade market price
'''

class FMAlgorithm2(FuturesAlgorithmBase):
    ...
    def buy(self, price, amount, order_type='LIMIT'):
        ...
        self.futures.buy(0, purchase_amount, order_type)
    ...
    def sell(self, price, amount, order_type='LIMIT'):
        ...
        self.futures.sell(0, sale_amount, order_type)
        ...
        try:
            ...
            for trade_time, price in self.close_position_purchase_history.items():
                ...
                if x > x1:
                    ...
                    self.trader.chart_ax.plot(x, price, marker='o', markersize=4, color='Indigo')
