...
class FMAlgorithm33(FuturesAlgorithmBase):
    ...
    def market_status(self, item):
        ...
        if item.item_code == self.chart_item.item_code:
            kospi200_interval = self.kospi200.chart.index[(self.r1_interval * -2):]
            futures_interval = self.futures.chart.index[(self.r1_interval * -2):]
            self.debug(self.futures.chart.loc
                       [futures_interval, ['PAR1_Slope', 'PAR1_SlopeSlope', 'PAR1_CorrectedSlope', 'position']])
            self.debug(self.kospi200.chart.loc
                       [kospi200_interval, ['PAR1_Slope', 'PAR1_SlopeSlope', 'PAR1_CorrectedSlope', 'position']])
