...
class FMAlgorithm41(FuturesAlgorithmBase):
    ...
    def monitor_trend_deviation(self, current_price):
        ...
        current_slope = chart.MA5R1_Slope[-2]
        current_time = chart.index[-1]
        previous_position = chart.position[-self.predict_ahead - 2]
        ...
        if not self.futures.holding_amount:
            if current_slope >= 0:
        ...
        if chart.MA5R1_Slope[-2] * chart.MA5R1_Slope[-3] < 0:
            previous_consecutive_slope_count = self.get_consecutive_slope_count(chart, 2)
        ...
        if anticipated_position == LONG_POSITION:
            ...
            self.buy(self.bet_amount * 3, 0, 'MARKET')
            ...
            self.sell(self.bet_amount * 3, 0, 'MARKET')
