...
class FMAlgorithm30(FuturesAlgorithmBase):
    ...
    def update_chart_prices(self, item_code, price, volume):
        ...
        # previous_volume = chart.Volume[-1]
        # current_volume = previous_volume + volume
        current_volume = chart.Volume[-1]
        surplus_quota = current_volume // self.quantum_volume
        if surplus_quota:
            # surplus_volume = current_volume - self.quantum_volume
