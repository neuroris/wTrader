...
class TraderBase(QMainWindow, WookLog, WookUtil):
    ...
    def initUI(self):
        ...
        # algorithm_grid.addWidget(lb_total_profit, 0, 7)
        # algorithm_grid.addWidget(self.lb_total_profit, 0, 8)
        algorithm_grid.addLayout(hbox_total_profit, 0, 7, 1, 4)
